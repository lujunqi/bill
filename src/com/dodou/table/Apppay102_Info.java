...
public class Apppay102_Info implements TableBeanInterface
{
	private String REMARK_INFO;// 备注信息
	private int APPPAY_ID = 1;
	private int COMMERCIAL_ID;// NUMBER not null,
	private String APPTYPE = "102";// CHAR(3) not null,
	...
	private int E_ID = 0;
	private String ORDER_NO = " ";// CHAR(10) not null,
	...
	private Date INPUT_DATE = new Date(System.currentTimeMillis());// DATE not
			...
			throws Exception
	{
		...
		{
			this.setORDER_NO(request.getParameter("ORDER_NO"));
		}
		...
		} else if ("3".equals(this.getFEE_TYPE()))
		{
			if (null != FEE_SET_TOP)
			{
//			        double top = Double.parseDouble(FEE_SET_TOP);
				this.setFEE_SET(base + "," + FEE_SET_TOP + "00");
			}
		} else
			this.setFEE_SET(base);
	}
