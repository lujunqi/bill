...
<%
    try {
		...
		if (null == id) {
			...
			String sql = "update TEMINAL_INFO_SERV set host_seq='' where TEMINAL_INFO_SERV_ID="
				+ id;
			DatabaseAccess acc = new DatabaseAccess();
			acc.executeUpdate(sql);
			LogService ls = new LogService();
			Operman_info o = (Operman_info)session.getAttribute("man");
			String tempSql = ls.newLog(Terminal_InfoDao.TABLE,o.getOperman_name(), Integer.parseInt(id), 400, "清空主机序列号:"+request.getParameter("host_no"));
