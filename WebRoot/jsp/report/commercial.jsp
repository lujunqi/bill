...
try{
	cmd.init("commercial",dba.getConnection());
	list = cmd.getENum();
}catch(Exception e){
}
cmd.closeConntent();
...
<div class="left02topDiv">
  ...
  <div class="left02top_c" id="titleInfo" style="width: 600px">台账报表-&gt;商户报表</div>
</div>
<div class="left02downDiv">
  <form id="detail_custForm" onsubmit="exportReport()" action="../../commercial.rp" target="_blank" method="post">
  ...
  <form id="queryForm">
    <table id='cust_Table' class="dataTable" >
      <thead id="tableHead">
        ...
        <tr>
          <%
//List<String[]> list = com.ljq.MyEnum.commercialTitle;
for(int i=0;i<list.size();i++){
	String[] t = list.get(i);
