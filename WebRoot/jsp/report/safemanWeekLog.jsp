...
function find(cur_page){
    ...
    if ($('#safe_man').val() != ''){
    	sqlstr += " and t.safe_man = '"+$('#safe_man').val()+"'";
   }
    sqlstr += " ";
	...
	$.ajax({
		url:'../action/safemanWeekQuery.jsp',
		dataType:'json',
		type:'POST',
	...
	function exportReport()
	{
		...
		var cust_Table = document.getElementById('cust_Table');
	   	location.href='../action/report/safemanWeekLogReportCreate.jsp?date1='+$('#startTime').val()+'&date2='+$('#endTime').val();
	}
</script>
...
<body>
	...
	<div id=detailDiv class="left02">
		<div class="left02topDiv">
			...
			<div class="left02top_c" id="titleInfo" style="width: 600px">维护人收益报表->查询条件</div>
		</div>
		...
		<tr>
			...
			<td align='right' width="8%">维护人:</td>
			<% com.szzt.dao.DaoUtils daoUtils=new com.szzt.dao.DaoUtils();%>
			<td><select id="safe_man" name="safe_man">
					<option value="">---请选择---</option>
					<%
					List<KeyValueModel> expands=daoUtils.operateUser(Permission.SAFE_POSITION);
