...
try{
	cmd.init("terminal",dba.getConnection());
	list = cmd.getENum();
}catch(Exception e){
}
cmd.closeConntent();
...
<div class="left02topDiv">
  ...
  <div class="left02top_c" id="titleInfo" style="width: 600px">台账报表-&gt;终端台账</div>
</div>
<div class="left02downDiv">
  <form id="detail_custForm" onsubmit="exportReport()" target="_blank" action="../../terminal.rp"  method="post">
