...
function find(cur_page){
	...
	$.ajax({
		url:'../action/merMonTotalQuery.jsp',
		dataType:'json',
		type:'POST',
...
<body>
	...
	<div id=detailDiv class="left02">
		...
		<tr>
			<td align='right' width="8%">查询年份:</td>
			<td>
				<input  readonly="readonly" style='width: 100px' id="startTime" name="startTime" onclick="WdatePicker({dateFmt:'yy'});" class="Wdate" />
			</td>
