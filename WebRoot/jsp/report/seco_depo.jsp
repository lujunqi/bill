...
function find(cur_page){
    ...
    sqlstr += " and to_char(t.in_time,'yyyy')='2014' ";
...
<body>
	...
	<div id=detailDiv class="left02">
		...
		<tr>
			...
			<td width="30%">
				<input  readonly="readonly" style='width: 100px' id="startTime" name="startTime" onclick="WdatePicker({dateFmt:'MMdd'});" class="Wdate" />
				至
				<input  readonly="readonly" style='width: 100px' id="endTime" name="endTime" onclick="WdatePicker({dateFmt:'MMdd'});" class="Wdate" />
			</td>
			...
			<td align='right' width="8%">商户编号:</td>
			<td width="13%">
				<input   style='width: 100px' id="merchantsno" name="merchantsno" />
			</td>	
			<td align='right' width="8%">PSAM卡号:</td>
			<td width="13%">
				<input   style='width: 100px' id="psam" name="psam" />
			</td>					
		</tr>
		<tr>
	...
	<div id="listDiv" class="left02">
		...
		<table id='cust_Table' class='dataTable1' width="100%">
			<tr>
				...
				<th class='dataTableHeader'>上送终端名称	</th>
				...
				<th class='dataTableHeader'>记账联号</th>
				<th class='dataTableHeader'>PSAM卡号</th>
			...
			<tr id='merDayGain_Templet' >
				...
				<td id='shop_nm' ></td>
				<td id="term_id1"></td>
				<td id="marchant_name" style="width: 22%"></td>
				<td id="term_id2"></td>
				<td id="sales_man"></td>
				<td id="terminalsno"></td>
				<td id="fld_57"></td>
				<td id="amt"></td>
				<td id="fld_48"></td>
			</tr>	
