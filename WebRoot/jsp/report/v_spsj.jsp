...
try{
	cmd.init("v_spsj",dba.getConnection());
	list = cmd.getENum();
}catch(Exception e){
}
cmd.closeConntent();
...
<div class="left02topDiv">
  ...
  <div class="left02top_c" id="titleInfo" style="width: 600px">台账报表-&gt;审批数据查询</div>
</div>
...
%>
  ...
  <form id="detail_custForm" onsubmit="exportReport()" target="_blank" action="../../v_spsj.rp"  method="post">
    <div style=" clear:both"></div>
    <div id="search_div">
      <li>
        <label >审批时间:</label>
        <input type="text" name="sj"  style="width:60px;"  readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" />
      </li>
    </div>
