...
{$(this).remove();});});});});$(this).find('[name=submit]').click(function(item)
{var canSubmit=true;$('#'+formName).find('input').each(function()
...
{item.preventDefault();if(callback)
{callback($(this).serialize());}}});var functions={validateString:function(type,string)
{if(type=='email')
